...
public class JFrame1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("WELCOME TO BJR CAFE");

        jLabel4.setText("Enter valid credentials");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().equals("admin")&&jPasswordField1.getText().equals("bjrn")){
        JFrame2 f=new JFrame2();
        f.show();
        dispose();
        }
        else if(jTextField1.getText().equals(jPasswordField1.getText())){
            JFrame3 g=new JFrame3();
            g.show();
            dispose();
        }
        else{
